...
export const busyPhrases = [
  ...
  // Rioplatense wit (playful + professional)
  "Bancame que lo dejo con moñito...",
  "Está saliendo prolijo, como mantel de domingo...",
  "Un mate de paciencia y seguimos...",
  "Tranqui, esto viene con buena letra...",
  "Le estoy dando el último toque de gala...",
  "Va quedando fino, sin hacer espamento...",
  "Acomodando las ideas como mesa familiar...",
  "Esto viene sereno, pero con presencia...",
  "Dame un suspiro y queda elegante...",
  "Sin correr, que lo lindo pide tiempo...",
  "Le falta una peinada y sale a la cancha...",
  "Estoy afinando detalles, bien de entrecasa...",
  "Un toque de paciencia, que viene lindo...",
  "Va derechito como colectivo en avenida vacía...",
  "Lo estoy dejando presentable para la foto...",
  "Esto se cocina a fuego amable...",
  "Calma, que la elegancia no se apura...",
  "Ya casi levanta la persiana...",
  "Va con paso firme y sonrisa discreta...",
  "Le estoy sacando brillo al resultado...",
  "Un compás más y entra perfecto...",
  "Esto viene con perfume a cosa bien hecha...",
  "Aguantá que se está acomodando solo...",
  "Queda pipí cucú, palabra de caballero...",
